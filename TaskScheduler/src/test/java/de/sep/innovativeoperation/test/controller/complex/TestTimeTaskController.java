...
public class TestTimeTaskController {
	...
	public void testUpdateTimeTaskOne200() throws Exception {
		...
		when(timeTaskResourceService.updateTimeTask(1, timeTaskResource))
	...
	@Test
	// TODO MOCK TimeResourceService
	public void testDeleteTimeTask204() throws Exception {
	...
	@Test
	// TODO MOCK TimeResourceService
	public void testCreateTimeTask201() throws Exception {

		when(timeTaskResourceService.createTimeTask(timeTaskResource))
				.thenReturn(timeTaskResource);
