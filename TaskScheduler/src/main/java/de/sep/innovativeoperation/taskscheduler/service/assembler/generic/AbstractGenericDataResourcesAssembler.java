...
//TODO
public abstract class AbstractGenericDataResourcesAssembler<D extends AbstractDataModel, R extends AbstractGenericResourceModel<D>, S extends AbstractGenericResourcesModel<R>   > extends ResourceAssemblerSupport<Iterable<R>, S >{

	public AbstractGenericDataResourcesAssembler(Class<?> controllerClass,
